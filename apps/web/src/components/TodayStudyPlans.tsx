...
import TodayProgressRing from "@/web/components/TodayProgressRing";
          ...
          <>
            ...
            {state === "active" ? (
              readOnly ? (
                ...
                <Button asChild size="lg" className="mt-4 h-11 w-full sm:w-auto">
                  <Link to="/#study-start">学習を始める</Link>
                </Button>
              )
            ) : state === "empty" ? (
              <Button
            ...
            {!hasError ? (
              <div className="mt-4 flex flex-wrap items-center justify-between gap-2 text-sm text-muted-foreground">
                ...
                <Link to="/dashboard#study-calendar" className="font-medium text-primary hover:underline">
                  学習予定カレンダー →
                </Link>
              </div>
            ) : null}
