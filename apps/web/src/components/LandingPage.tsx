...
import {
  ...
  HeroReveal,
  Reveal,
} from "@/web/components/landing/LandingMotion";
...
import examScheduleImage from "@/web/components/landing/images/exam-schedule.png";
import studyCalendarImage from "@/web/components/landing/images/study-calendar.png";
import studyStartDialogImage from "@/web/components/landing/images/study-start-dialog.png";
import studyStartHeroImage from "@/web/components/landing/images/study-start-hero.png";
import subjectStudyTimeImage from "@/web/components/landing/images/subject-study-time.png";
...
const ScreenshotCard = ({
  ...
  // Vite では画像 import は URL 文字列になる（Next.js の StaticImageData 相当）。
  src: string;
  alt: string;
}) => (
