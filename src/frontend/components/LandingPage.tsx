...
import {
  ...
  HeroReveal,
  Reveal,
} from "@/frontend/components/landing/LandingMotion";
import TrackedSignupLink from "@/frontend/components/analytics/TrackedSignupLink";
// 画像は public/ ではなく import で読み込む。ビルド時にファイル名へコンテンツ
// ハッシュが付くため、中身を差し替えれば URL が変わりキャッシュが自動で外れる。
// width/height も import した値から自動で決まる。
import examScheduleImage from "@/frontend/components/landing/images/exam-schedule.png";
import studyCalendarImage from "@/frontend/components/landing/images/study-calendar.png";
import studyStartDialogImage from "@/frontend/components/landing/images/study-start-dialog.png";
import studyStartHeroImage from "@/frontend/components/landing/images/study-start-hero.png";
import subjectStudyTimeImage from "@/frontend/components/landing/images/subject-study-time.png";
